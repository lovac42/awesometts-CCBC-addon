...
class BrowserStripper(Dialog):
    ...
    def _ui_buttons(self):
        ...
        buttons.findChild(QAbstractButton, 'okay').setText("&Remove Now")
    ...
    def show(self, *args, **kwargs):
        ...
        self.findChild(QScrollArea, 'scroll').setWidget(panel)
        ...
        (
            ...
            or self.findChild(QRadioButton)  # use first if config bad
        ).setChecked(True)
